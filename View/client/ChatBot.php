    ...
    $(document).ready(function () {
        $('#sendButton').click(function () {
            ...
            if (userInput.trim()) {
                ...
                addMessage('gemini', ''); // Placeholder for Gemini response
        ...
        function sendToGemini(userQuestion) {
            ...
            $.ajax({
                url: '  https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyA3IdKw82wxDPh0awkEs_hSlXG1cYVlVok',
                type: 'POST',
        ...
        function saveChat(question, response) {
            // Save the question and response to a list (e.g., localStorage, database, etc.)
            // Example: You can use localStorage here or server-side storage.
